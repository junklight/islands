...
-- l 1
  params:add_group("Layer 1",116)
  params:add_separator("Op Freq")
  ...
  params:add_separator("Op Vel Sens")
  ...
  params:add_separator("Op Matrix")
  ...
  params:add_separator("Op Carrier")
  ...
  params:add_separator("Op Env Curves")
